...
import com.bailiangjin.httprequest.net.okdownanduploadfile.ProgressHelper;
import com.bailiangjin.httprequest.net.okdownanduploadfile.listener.ProgressListener;
import com.bailiangjin.httprequest.net.okdownanduploadfile.listener.UIProgressListener;
...
public class TestFileDownLoadAndUploadActivity extends AppCompatActivity {
    ...
    public static void start(Activity activity){
        Intent intent = new Intent(activity, TestFileDownLoadAndUploadActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_file_dowload_and_upload);
        initView();
    }
    ...
    private void download() {
        ...
        final Request request1 = new Request.Builder()
                .url("http://bailiangjin.github.io/dev/download/release/SignApkTool_v0.93.jar")
                .build();
